...
use flake $flake_url#rust-dev --accept-flake-config
...
use flake $flake_url#python-dev --accept-flake-config
...
use flake $flake_url#nodejs-dev --accept-flake-config
...
use flake $flake_url#go-dev --accept-flake-config
...
use flake $flake_url#nix-dev --accept-flake-config
...
use flake $flake_url#universal-dev --accept-flake-config
