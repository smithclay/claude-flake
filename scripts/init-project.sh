...
use flake $flake_url#rust --accept-flake-config
...
use flake $flake_url#python --accept-flake-config
...
use flake $flake_url#nodejs --accept-flake-config
...
use flake $flake_url#go --accept-flake-config
...
use flake $flake_url#nix --accept-flake-config
...
use flake $flake_url#universal --accept-flake-config
